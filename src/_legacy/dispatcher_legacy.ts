// NOTE: Frozen snapshot of the pre-agent dispatcher (route() switch with
// onDiscover/onRefine/onGreeting/etc). Kept for reference and rollback.
// Nothing in live src/ imports this file.
...
import { formatCardText } from "./card_formatters.js";
...
import type { WatiInbound } from "../wati/types.js";
